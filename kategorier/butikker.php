...
?>
    ...
    <body id="barerimg">
        <div class="undersideeeee"><h1 id="undersideTittel">Butikker</h1></div>
        <div class="container">
            ...
            <div id="undersidor">
                ...
                <?php
                    ...
                    $postsystem = "SELECT DISTINCT postid, tittel, kategori, bildeURL, post FROM steder WHERE kategori=3 ORDER BY postid DESC";
