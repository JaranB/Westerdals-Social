...
?>
    ...
    <body id="helseimg">
        <div class="container">
            <div class="titelbox"><h1 id="undersideTittel">Helse</h1></div>
            <div id="undersidor">

                <?php

                    $postsystem = "SELECT DISTINCT postid, tittel, kategori, bildeURL, post FROM steder WHERE kategori=5 ORDER BY postid DESC";
